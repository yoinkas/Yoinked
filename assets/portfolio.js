...
const translations = {
  es: {
    ...
    "Learning how to make websites while building real cybersecurity projects, portfolio pages, and web applications with modern tools.": "Aprendiendo a crear sitios web mientras construyo proyectos reales de ciberseguridad, paginas de portafolio y aplicaciones web con herramientas modernas.",
  ...
  fr: {
    ...
    "Learning how to make websites while building real cybersecurity projects, portfolio pages, and web applications with modern tools.": "J'apprends a creer des sites web tout en construisant de vrais projets de cybersecurite, des pages de portfolio et des applications web avec des outils modernes.",
